...
# Salva modello
model_file <- file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_2", "bbi_model.stan")
...
results_file <- "C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_2/stan_results.RData"
save(fit, stan_data, summary, diagnostics_list,
     file = results_file)

# Salva anche le diagnostiche in CSV
write.csv(summary, 
          file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_2", "summary.csv"), 
          row.names = TRUE)

write.csv(ess_summary, 
          file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_2", "diagnostics.csv"), 
          row.names = FALSE)
