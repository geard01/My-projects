...
data_folder <- "C:/Users/geard/OneDrive/Download/Tesi/dati_ts/dataset_2"
...
generated quantities {
  ...
  for (i in 1:N) {
    F_rep[i] = gamma_rng(alpha, alpha/mu[i]); 
    log_lik[i] = gamma_lpdf(F[i] | alpha, alpha/mu[i]); 
  }
}
"
...
# Salva modello
model_file <- file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_2", "bbi_model_gamma.stan")
...
results_file <- "C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_2/stan_results_gamma.RData"
save(fit, stan_data, summary, diagnostics_list,
     file = results_file)

# Salva anche le diagnostiche in CSV
write.csv(summary, 
          file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_2", "summary_gamma.csv"), 
          row.names = TRUE)

write.csv(ess_summary, 
          file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_2", "diagnostics_gamma.csv"), 
          row.names = FALSE)
