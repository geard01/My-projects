...
# Salva modello
model_file <- file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_1", "bbi_model_gamma.stan")
...
results_file <- "C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_1/stan_results_gamma.RData"
save(fit, stan_data, summary, diagnostics_list,
     file = results_file)

# Salva anche le diagnostiche in CSV
write.csv(summary, 
          file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_1", "summary_gamma.csv"), 
          row.names = TRUE)

write.csv(ess_summary, 
          file.path("C:/Users/geard/OneDrive/Download/Tesi/STAN/Dataset_1", "diagnostics_gamma.csv"), 
          row.names = FALSE)
